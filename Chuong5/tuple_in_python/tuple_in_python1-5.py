...
# 1 hash object  là 1 đối tượng ta không thể thay đổi nội dung/bất biến (immutable) của nó
...
""" Tuple khác list ở chỗ : - Tuple không cho phép ta sửa chữa nội dung và list thì ngược lại """
